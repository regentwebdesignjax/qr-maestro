...
export default function Pricing() {
  ...
  const isPaidActive = (tier) =>
    ['black_belt', 'grand_master'].includes(tier) && user?.subscription_status === 'active';

  const isBlackBelt = user?.subscription_tier === 'black_belt' && user?.subscription_status === 'active';
