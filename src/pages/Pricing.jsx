            ...
            <CardContent className="flex flex-col flex-1 space-y-4">
              ...
              <div className="pt-2">
                {user ? (
                  ...
                  <Button variant="outline" className="w-full font-semibold hover:scale-[1.01]" onClick={() => base44.auth.redirectToLogin('/Dashboard')}>
                    Get Started
                  </Button>
                )}
              </div>
            ...
            <CardContent className="flex flex-col flex-1 space-y-4">
              ...
              <div className="pt-2">
                {isPro && user?.subscription_period === 'monthly' ? (
                  ...
                  <Button className="w-full font-semibold hover:scale-[1.01] hover:shadow-md" onClick={() => handleUpgrade('monthly')} disabled={loading || (isPro && user?.subscription_period === 'annual')}>
            ...
            <CardContent className="flex flex-col flex-1 space-y-4">
              ...
              <div className="pt-2">
                {isPro && user?.subscription_period === 'annual' ? (
                  ...
                  <Button className="w-full font-semibold hover:scale-[1.01] hover:shadow-md" onClick={() => handleUpgrade('annual')} disabled={loading || (isPro && user?.subscription_period === 'monthly')}>
                    <Zap className="w-4 h-4 mr-2" />
                    {user ? 'Upgrade to Pro' : 'Sign Up Now'}
                  </Button>
                )}
